...
List<ContactVO> contactData = [
  ContactVO(
    ...
    name: 'A张三',
    avatarUrl:
        'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1540633615163&di=e6662df8230b7e8a87cf0017df7252b7&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimgad%2Fpic%2Fitem%2Fac345982b2b7d0a2d1f5b989c0ef76094b369ae2.jpg',
  ),
  ContactVO(
      seationKey: 'A',
      name: '阿黄',
  ...
  ContactVO(seationKey: 'J', name: 'JC', avatarUrl: ''),
  ContactVO(seationKey: 'J', name: 'JCZ', avatarUrl: ''),
  ...
  ContactVO(
      ...
      name: '老司机',
      avatarUrl: 'http://www.qqzhi.com/uploadpic/2014-10-14/001343706.jpg'),
  ContactVO(seationKey: 'L', name: '辣眼睛', avatarUrl: ''),
  ContactVO(seationKey: 'M', name: 'Mary', avatarUrl: ''),
  ContactVO(seationKey: 'M', name: 'Master', avatarUrl: ''),
  ContactVO(seationKey: 'P', name: '彭于晏', avatarUrl: ''),
  ContactVO(seationKey: 'P', name: '彭简', avatarUrl: ''),
  ContactVO(
      seationKey: 'Q',
      name: '乔大',
      avatarUrl:
  ...
  ContactVO(seationKey: 'S', name: '沈家', avatarUrl: ''),
  ContactVO(
      seationKey: 'T',
      name: '天天',
      avatarUrl:
